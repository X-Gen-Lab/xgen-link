...
/*---------------------------------------------------------------------------*/
/* CRC8 MAXIM Lookup Table                                                   */
/*---------------------------------------------------------------------------*/

/**
 * \brief           CRC8 lookup table for MAXIM polynomial (0x31)
 * \details         Generated for polynomial 0x31 (x^8 + x^5 + x^4 + 1)
 *                  Initial value: 0x00
 */
...
/**
 * \brief           CRC16 lookup table for MODBUS polynomial (0x8005)
 * \details         Generated for polynomial 0x8005 (x^16 + x^15 + x^2 + 1)
...
uint8_t xgl_crc8_maxim(const uint8_t* data, size_t len) {
    return xgl_crc8_maxim_update(0x00, data, len);
}
...
uint16_t xgl_crc16_modbus(const uint8_t* data, size_t len) {
    return xgl_crc16_modbus_update(0xFFFF, data, len);
}
