...
#define XGL_FRAGMENT_EXT_SIZE       (XGL_WIRE_EXT_HEADER_SIZE + XGL_FRAGMENT_EXT_VALUE_SIZE)
#define XGL_SESSION_EXT_VALUE_SIZE  12U
#define XGL_SESSION_EXT_SIZE        (XGL_WIRE_EXT_HEADER_SIZE + XGL_SESSION_EXT_VALUE_SIZE)
